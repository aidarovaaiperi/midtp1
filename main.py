...
def callback_worker(call):
    if call.message:
        if call.data =="1":
         ...
         bot.edit_message_text = ('Чизкейки, которые побили мировой рекорд в кулинарном мире. Так, наверное, можно сказать про первую книгу кондитера и популярного блогера Виктории Мельник «Чизкейк внутри», ставшую бестселлером в 2018 году. В понятные и доступные рецепты идеальных десертов влюбились тысячи домашних кондитеров. Вторая книга Виктории – перед вами. Абсолютно новые оригинальные авторские рецепты чизкейков и других сладостей, дополненные разделом теории. Восхитительные вдохновляющие фотографии и понятное описание приготовления. Почувствуйте себя настоящим кондитером!')
